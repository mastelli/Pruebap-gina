  ...
  return (
    <div className="isolate min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <p className="mt-3 text-sm text-muted-foreground">Última actualización: 6 de septiembre de 2026</p>
        ...
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-between gap-3 sm:flex-row">
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2">
              <Link href="/privacidad" className="text-sm text-muted-foreground transition-colors hover:text-foreground">Privacidad</Link>
              <Link href="/terminos" className="text-sm text-muted-foreground transition-colors hover:text-foreground">Términos</Link>
              <Link href="/cookies" className="text-sm text-muted-foreground transition-colors hover:text-foreground">Cookies</Link>
              <Link href="/seguridad" className="text-sm text-muted-foreground transition-colors hover:text-foreground">Seguridad</Link>
