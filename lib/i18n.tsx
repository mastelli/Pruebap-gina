...
const translations: Record<string, string> = {
  ...
  "Win probability": "Probabilidad de ganar",
  "Loss probability": "Probabilidad de perder",
  "Avg gain": "Ganancia media",
  "Avg loss": "Pérdida media",
  "Monte Carlo simulation over historical returns": "Simulación Monte Carlo sobre los retornos históricos",
  "scenarios of": "escenarios de",
  "historical sessions": "sesiones históricas",
  "Insufficient historical data for EV": "Datos históricos insuficientes para el EV",
  "Worst case": "Peor escenario",
  "Conservative (Q25)": "Conservador (Q25)",
  "Conservative EV uses the 25th percentile": "EV conservador basado en el percentil 25",
  "Potential": "Potencial",
  ...
  "Investment Test": "Test Inversión",
  "Search by symbol or company name...": "Buscar por símbolo o nombre de empresa...",
  "Loading stock data...": "Cargando datos de la acción...",
  "Technical Chart": "Gráfico Técnico",
  "Valuation": "Valoración",
  "Analyst Recommendations": "Recomendaciones de Analistas",
  "Growth": "Crecimiento",
  "Profitability": "Rentabilidad",
  "Balance Sheet & Cash Flow": "Balance y Flujo de Caja",
  "Risk & Ownership": "Riesgo y Propiedad",
  ...
  High: "Máximo",
  Upside: "Potencial",
  "Rating Distribution": "Distribución de Recomendaciones",
  analysts: "analistas",
  Sector: "Sector",
  Industry: "Industria",
  Country: "País",
  ...
  "% Held by Insiders": "% en Manos de Insiders",
  "% Held by Institutions": "% en Manos de Institucionales",
  "Revenue Growth": "Crecimiento de Ingresos",
  "Earnings Growth": "Crecimiento de Beneficios",
  "Sales Growth QoQ": "Crecimiento de Ventas Trimestral",
  "5Y Revenue Growth": "Crecimiento Ingresos 5A",
  "Est. Revenue Growth": "Crec. Ingresos Estimado",
  "FCF Growth": "Crecimiento de FCF",
  "Est. EPS Current Year": "BPA Estimado Año Actual",
  "Est. EPS Next Year": "BPA Estimado Próximo Año",
  ...
  "Trailing EPS": "BPA TTM",
  "Forward EPS": "BPA Forward",
  ...
  "No analyst targets available": "No hay objetivos de analistas disponibles",
  "Low P/E indicates undervaluation": "P/E bajo indica infravaloración",
  "High P/E suggests overvaluation": "P/E alto sugiere sobrevaloración",
  "P/E is within normal range": "P/E en rango normal",
  "PEG < 1: growth is cheap relative to earnings": "PEG < 1: crecimiento barato relativo a beneficios",
  "PEG > 2: paying premium for growth": "PEG > 2: pagando prima por crecimiento",
  "Trading below book value — rare opportunity": "Negociando por debajo del valor contable — oportunidad rara",
  "ROE > 20% — excellent capital efficiency": "ROE > 20% — excelente eficiencia de capital",
  "ROE < 5% — poor capital allocation": "ROE < 5% — mala asignación de capital",
  "Strong profit margins above 20%": "Márgenes de beneficio fuertes por encima del 20%",
  "High gross margins — strong pricing power": "Márgenes brutos altos — fuerte poder de fijación de precios",
  "Revenue growth > 15% — strong momentum": "Crecimiento de ingresos > 15% — fuerte impulso",
  "Declining revenue — growth concerns": "Ingresos en declive — preocupaciones de crecimiento",
  "Earnings growing faster than revenue — improving efficiency": "Beneficios creciendo más rápido que ingresos — eficiencia mejorando",
  "Low debt — conservative balance sheet": "Baja deuda — balance conservador",
  "High debt levels — financial risk": "Niveles altos de deuda — riesgo financiero",
  "Strong liquidity position": "Posición de liquidez fuerte",
  "Positive free cash flow — self-funding growth": "Flujo de caja libre positivo — crecimiento autofinanciado",
  "Analyst consensus is bullish": "El consenso de analistas es alcista",
  "Analyst consensus is bearish": "El consenso de analistas es bajista",
  "Significant upside to analyst target price": "Potencial significativo respecto al precio objetivo",
  "High beta — more volatile than market": "Beta alto — más volátil que el mercado",
  "Low beta — defensive stock": "Beta bajo — acción defensiva",
  "Significant insider ownership — aligned interests": "Propiedad significativa de insiders — intereses alineados",
