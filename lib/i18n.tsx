...
const translations: Record<string, string> = {
  ...
  "Which tool": "¿Cuál necesitas?",
  "Which tool hint": "Compara en un vistazo para qué sirve cada calculadora.",
  "Column calculator": "Calculadora",
  "Column purpose": "Para qué sirve",
  "Column result": "Qué obtienes",
  "Compound purpose": "Planificar cuánto crecerá tu ahorro con aportaciones y reinversión de intereses.",
  "Compound result": "Valor final, intereses generados y evolución año a año.",
  "Real estate purpose": "Saber si una vivienda en alquiler es rentable de verdad.",
  "Real estate result": "TIR, ROI anualizado, cash flow y análisis de sensibilidad.",
  "Stocks purpose": "Valorar empresas de bolsa y medir su salud financiera.",
  "Stocks result": "Valoración, métricas clave y gráficos históricos.",
