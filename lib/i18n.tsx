...
const translations: Record<string, string> = {
  ...
  "Loading session activity": "Cargando actividad de sesión…",
  "Unable to load session activity": "No se ha podido cargar la actividad de sesión",
  "No sign-ins recorded yet": "Aún no hay inicios de sesión registrados",
