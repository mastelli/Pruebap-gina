...
const translations: Record<string, string> = {
  ...
  "Manual Stocks": "Acciones manuales",
  ...
  "No stocks added": "No se han añadido acciones",
  ...
  // Balance 2
  "Balance 2": "Balance 2",
  "Personal financial balance": "Balance financiero personal",
  ...
  "TOTAL PASIVOS + PATRIMONIO": "TOTAL PASIVOS + PATRIMONIO",
  "Balance Visual": "Balance Visual",
  "Discrepancy detected": "Discrepancia detectada",
  "Financial Health": "Salud financiera",
  "Emergency Fund": "Fondo de emergencia",
  "months of essential expenses covered": "meses de gastos esenciales cubiertos",
  "Essential Monthly Expenses": "Gastos mensuales esenciales",
  "Add Asset": "Añadir activo",
  "Add Liability": "Añadir pasivo",
  "No items": "Sin elementos",
  "Add Entry": "Añadir movimiento",
  "Add Cash Flow Entry": "Añadir movimiento de flujo de caja",
  "Total Income": "Total ingresos",
  "Total Expenses": "Total gastos",
  "Net Cash Flow": "Flujo de caja neto",
  Incomes: "Ingresos",
  Expenses: "Gastos",
  "No entries": "Sin movimientos",
  "No data": "Sin datos",
  "Asset Distribution": "Distribución de activos",
  "Liability Distribution": "Distribución de pasivos",
  "Assets vs Liabilities": "Activos vs Pasivos",
  "Patrimony Composition": "Composición del patrimonio",
  Current: "Corriente",
  "Non-current": "No corriente",
  Assets: "Activos",
  Liabilities: "Pasivos",
  "Save Snapshot": "Guardar snapshot",
  ...
  "Salary": "Nómina",
  "Bizum/Transferencia": "Bizum/Transferencia",
  ...
  "Total Bizum/Transferencia": "Total Bizum/Transferencia",
  ...
  "Positive Net Worth": "Patrimonio neto positivo",
  "Negative Net Worth": "Patrimonio neto negativo",
  "Your net worth is": "Tu patrimonio neto es",
  "This means your assets exceed your liabilities, which is a healthy financial position.": "Esto significa que tus activos superan tus pasivos, lo cual es una posición financiera saludable.",
  "Your liabilities exceed your assets. Focus on reducing debt and increasing savings.": "Tus pasivos superan tus activos. Enfócate en reducir deudas y aumentar el ahorro.",
  "Strong Emergency Fund": "Fondo de emergencia sólido",
  "Moderate Emergency Fund": "Fondo de emergencia moderado",
  "Low Emergency Fund": "Fondo de emergencia bajo",
  "You have": "Tienes",
  "months of essential expenses covered. This is above the recommended 6-month minimum.": "meses de gastos esenciales cubiertos. Esto está por encima del mínimo recomendado de 6 meses.",
  "months of essential expenses covered. Consider building up to 6 months for better security.": "meses de gastos esenciales cubiertos. Considera alcanzar 6 meses para mayor seguridad.",
  "months of essential expenses covered. It is recommended to have at least 3-6 months.": "meses de gastos esenciales cubiertos. Se recomienda tener al menos 3-6 meses.",
  "Positive Cash Flow": "Flujo de caja positivo",
  "Negative Cash Flow": "Flujo de caja negativo",
  "Your monthly cash flow is positive at": "Tu flujo de caja mensual es positivo en",
  "of income": "de ingresos",
  "Keep this trend to build wealth over time.": "Mantén esta tendencia para construir riqueza con el tiempo.",
  "Your monthly cash flow is negative at": "Tu flujo de caja mensual es negativo en",
  "You are spending more than you earn. Review your expenses.": "Estás gastando más de lo que ingresas. Revisa tus gastos.",
  "Excellent Liquidity": "Liquidez excelente",
  "Adequate Liquidity": "Liquidez adecuada",
  "Low Liquidity": "Liquidez baja",
  "Your liquidity ratio is": "Tu ratio de liquidez es",
  "You can cover your short-term debts twice over, which shows strong financial flexibility.": "Puedes cubrir tus deudas a corto plazo dos veces, lo que muestra una fuerte flexibilidad financiera.",
  "You can cover your short-term debts, but there is room for improvement.": "Puedes cubrir tus deudas a corto plazo, pero hay margen de mejora.",
  "You may struggle to pay short-term debts. Consider building more liquid assets.": "Puede que te cueste pagar deudas a corto plazo. Considera construir más activos líquidos.",
  "Low Debt Level": "Nivel de deuda bajo",
  "Moderate Debt Level": "Nivel de deuda moderado",
  "High Debt Level": "Nivel de deuda alto",
  "Your debt represents": "Tu deuda representa",
  "of your total assets. This is a healthy level that gives you financial flexibility.": "de tus activos totales. Este es un nivel saludable que te da flexibilidad financiera.",
  "of your total assets. Consider a debt reduction strategy.": "de tus activos totales. Considera una estrategia de reducción de deuda.",
  "of your total assets. This is a concerning level that requires attention.": "de tus activos totales. Este es un nivel preocupante que requiere atención.",
  "Excellent Savings Rate": "Tasa de ahorro excelente",
  "Good Savings Rate": "Tasa de ahorro buena",
  "Low Savings Rate": "Tasa de ahorro baja",
  "You are saving": "Estás ahorrando",
  "of your income. This is above the recommended 20% and will help you achieve financial goals faster.": "de tus ingresos. Esto está por encima del 20% recomendado y te ayudará a alcanzar tus metas financieras más rápido.",
  "of your income. Try to increase this to 20% or more for better long-term security.": "de tus ingresos. Intenta aumentar esto al 20% o más para mayor seguridad a largo plazo.",
  "of your income. Consider ways to reduce expenses or increase income.": "de tus ingresos. Considera formas de reducir gastos o aumentar ingresos.",
  "Overall Assessment": "Evaluación general",
  "Your financial health looks strong. Keep maintaining good habits and focus on long-term wealth building.": "Tu salud financiera se ve sólida. Sigue manteniendo buenos hábitos y enfócate en construir riqueza a largo plazo.",
  "Your financial health needs attention in several areas. Prioritize building an emergency fund and reducing debt.": "Tu salud financiera necesita atención en varias áreas. Prioriza construir un fondo de emergencia y reducir deudas.",
  "Your financial health is moderate. Focus on improving your weak areas while maintaining your strengths.": "Tu salud financiera es moderada. Enfócate en mejorar tus áreas débiles mientras mantienes tus fortalezas.",
