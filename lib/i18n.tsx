...
const translations: Record<string, string> = {
  ...
  "Start example": "Empieza con un ejemplo",
  "Start example hint": "Resultados orientativos calculados con los valores por defecto de cada herramienta.",
  "Try it": "Probar",
  "In 20 years": "en 20 años",
  "Mortgage installment": "Cuota hipoteca",
  "Stocks example input": "Cualquier acción, p. ej. AAPL",
  "Instant valuation": "Valoración y gráficos al instante",
  "Compound example input": "10.000 € iniciales + 500 €/mes al 7%",
  "Real estate example input": "150.000 € · 70% financiado · 3% TIN a 30 años",
